...
public class FragmentLogin extends Fragment {
                ...
                fbs.getAuth().signInWithEmailAndPassword(username, password).addOnCompleteListener(getActivity(), new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if ( task.isSuccessful()){
                            ...
                            Toast.makeText(getActivity(), "Field to Login! Check user or password!", Toast.LENGTH_SHORT).show();
    ...
    private void gotoFragmentSignup() {
        FragmentTransaction ft = getActivity().getSupportFragmentManager().beginTransaction();
        ft.replace(R.id.frameLayoutMain, new FragmentSignup());
        ft.commit();
    }
}